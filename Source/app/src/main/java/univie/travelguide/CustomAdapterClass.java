...
public class CustomAdapterClass extends ArrayAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView nameTextField = (TextView) rowView.findViewById(R.id.tv_title);
        TextView infoTextField = (TextView) rowView.findViewById(R.id.tv_description);
        ImageView imageView = (ImageView) rowView.findViewById(R.id.image_view_row);
